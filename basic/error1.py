...
# print(dict1["addr"])# KeyError: 'addr' 없는거 찾아오라고 했을 때 key 에러

# x.index(40)  # ValueError: 40 is not in list

# f = open("data/111.txt", "r")  # FileNotFoundError: [Errno 2] No such file or directory
